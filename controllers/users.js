...
router.get("/users", async (req, res) => {
    ...
    //console.log((page * limite) - limite); // 3 * 10 - 10 = 20
...
router.put("/users/:id", async (req, res) => {
    ...
    const [rowsAffected] = await db.Users.update(dados, { where: {id: id}})
...
// Endereço para acessar através da aplicação externa: http://localhost:8080/users/2
router.delete("/users/:id", async (req, res) => {
    ...
    const rowsAffected = await db.Users.destroy({
